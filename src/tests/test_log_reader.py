...
class TestLogReader(unittest.TestCase):
    ...
    def xtest_summing_with_groupby(self):
        logpath = '/tmp/sum.log'
        f = open(logpath, 'w')
        f.write('g0\tbar\t[30/Jan/2012:18:07:09 +0000]\t5\n')
        f.write('g1\tbar\t[30/Jan/2012:18:08:09 +0000]\t7\n')
        f.write('g1\tbar\t[30/Jan/2012:18:08:09 +0000]\t11\n')
        f.write('g0\tbar\t[30/Jan/2012:18:11:09 +0000]\t13\n')
        f.write('g1\tbar\t[30/Jan/2012:18:12:00 +0000]\t13\n')
        f.close()
